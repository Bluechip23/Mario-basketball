...
namespace MarioBasketball.Gameplay
{
    ...
    ///   <item><b>Shot</b> – in flight toward a hoop after a shot/pass.</item>
    /// </list>
    ...
    public class BallController : MonoBehaviour
    {
        ...
        /// <summary>Whether a player is allowed to scoop up this loose ball.</summary>
        public bool CanBePickedUp => State == BallState.Free;
