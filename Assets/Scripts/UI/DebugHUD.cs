...
{
    /// <summary>
    /// A throwaway on-screen scoreboard and controls hint drawn with IMGUI.
    /// It needs no scene UI setup, which keeps the core-loop prototype to a
    /// single bootstrap object. Replace with a proper UGUI/UI Toolkit HUD
    /// once the game takes shape.
    /// </summary>
